...
ЗАДАЧА:
Из списка заголовков выбери НЕ БОЛЕЕ 5 самых важных и острых новостей, связанных с Ираном. Составь краткую сводку на русском языке.
...
- НЕ ДОДУМЫВАЙ последствия и выводы — никаких "что свидетельствует о...", "что может привести к...", "что указывает на...". Только сухой факт из заголовка.
- Если источники противоречат друг другу — кратко отрази обе стороны
- Если важных новостей меньше 5 — пиши сколько есть, НЕ добирай мелочью"""
