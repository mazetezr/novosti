...
ЗАДАЧА: Из пронумерованного списка заголовков выбери {news_count} самых важных новостей. Переведи каждый заголовок на русский и напиши ОДНО предложение — сам факт. Всё.
...
1. УГРОЗЫ И УЛЬТИМАТУМЫ от лидеров стран (Иран угрожает, США угрожают, Китай угрожает Тайваню)
2. Перемещение войск, кораблей, техники — Ормузский пролив, Тайваньский пролив, Персидский залив
3. КОНКРЕТНЫЕ ИНЦИДЕНТЫ — удары по нефтяным объектам, перехваты ракет, пожары на базах, атаки на танкеры, военные учения вокруг Тайваня
4. Ядерная программа — Иран, КНДР; полупроводниковая война (Тайвань/TSMC/санкции на чипы)
5. Дипломатия — медиация, переговоры, разрыв отношений, тарифы Трампа как инструмент давления
6. Нефть и энергетика — если напрямую связана с санкциями, войной, Ормузом, ОПЕК
