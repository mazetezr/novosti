...
3. Прямые удары по Ирану, удары Ирана по кому-то, бои
4. Ядерная программа — обогащение, испытания, МАГАТЭ
5. Дипломатия — медиация, переговоры, разрыв отношений

НЕ БЕРИ "рутинные" новости если есть что-то из пунктов выше:
- "Израиль бомбит Ливан" — это фоновая рутина, если рядом есть "США перебрасывают корабли через Ормуз"
- "Хезболла атаковала базу" — менее важно чем "Иран предупредил что ответит по любой стране-участнице"
